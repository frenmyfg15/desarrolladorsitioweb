...
import { Heart, Target, Users, Lightbulb, ArrowUpRight } from 'lucide-react';
...
export default function AboutUsSection() {
    return (
        <section className="relative z-90 px-20 py-20 max-[900px]:px-6">
            <div
                className="
        ...
        "
            ...
            "
                    ...
                    <p className="text-text-secondary text-xl leading-relaxed max-[900px]:text-base">
                        Somos un equipo de diseño y desarrollo enfocado en crear soluciones digitales
                        que tienen sentido para el negocio y para las personas que las usan.
                    </p>

                    <p className="text-text-secondary leading-relaxed">
                        Creemos en los procesos claros, en hablar sin tecnicismos innecesarios
                        y en entregar valor real en cada fase. No vendemos humo ni promesas vagas:
                        preferimos resultados, transparencia y relaciones a largo plazo.
                    </p>
                </div>
            ...
            "
                    >
                        <div className="flex flex-col gap-3 max-w-[720px]">
                            ...
                            <p className="text-text-secondary leading-relaxed">
                                Cada proyecto es distinto. Antes de escribir una línea de código,
                                entendemos el contexto, el objetivo y las limitaciones reales.
                                Pensamos en escalabilidad, mantenimiento y experiencia de usuario desde el inicio.
                            </p>
                        </div>
                    </div>
            ...
            "
                    >
                        <div className="flex flex-col gap-3 max-w-[720px]">
                            ...
                            <p className="text-text-secondary leading-relaxed">
                                Proyectos por fases, entregas claras y pagos por fase.
                                Así mantienes el control, reduces riesgos y ves avances reales desde el primer momento.
                            </p>
                        </div>
                    </div>
