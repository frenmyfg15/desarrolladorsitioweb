...
export default function Header() {
    ...
    return (
        <header className="fixed top-0 left-0 w-full z-[1000] overflow-x-hidden">
            {/* Barra superior */}
            ...
            {/* Overlay */}
            <div
                className={cx('fixed inset-0 z-[990] bg-black/30 backdrop-blur-[2px] transition-opacity duration-200', showMenu ? 'opacity-100' : 'opacity-0 pointer-events-none')}
