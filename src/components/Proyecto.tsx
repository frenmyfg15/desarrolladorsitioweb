...
const proyectos = [
  {
    ...
    descripcion: 'Un sitio moderno para empresas, construido con Next.js, Tailwind y optimizado para SEO.',
    imagen: '/proyecto/proyecto1.png',
  },
  {
    titulo: 'App Móvil de Tareas',
    descripcion: 'App para gestionar tareas diaria con React Native y Firebase en tiempo real.',
  ...
  return (
    ...
    >
      ...
      <div className="text-center max-w-3xl mx-auto">
        <h1
          className={`font-black text-3xl md:text-5xl lg:text-6xl text-white ${
            isVisible ? 'animate__animated animate__backInLeft animate__faster' : ''
          }`}
        >
          PROYECTOS
        </h1>
        <p className="mt-4 text-gray-300 text-base md:text-lg">
          Algunos de los trabajos más recientes en los que he participado, con enfoque en desarrollo web, apps móviles y
      ...
      <div className="flex-grow flex justify-center items-center w-full">
        <div className="relative flex flex-wrap justify-center items-center gap-8 md:gap-12 max-w-7xl w-full px-4">
          ...
          >
            <span className="bg-gradient-to-r from-[#22FF00] to-[#009966] px-8 py-3 rounded-2xl font-black text-white shadow-d hover:scale-105 transition">
          ...
          >
            <div className={`transition-all duration-300 ease-in-out bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 w-full max-w-lg ${
            ...
            <div className="mb-4">
              <h2 className="text-white font-bold text-2xl mb-2">{proyecto.titulo}</h2>
              <p className="text-gray-300 text-base">{proyecto.descripcion}</p>
            </div>
